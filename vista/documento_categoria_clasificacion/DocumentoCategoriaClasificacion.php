...
Phx.vista.DocumentoCategoriaClasificacion=Ext.extend(Phx.gridInterfaz,{
	...
	Atributos:[
		...
		},
		{
			config: {
				...
				store: new Ext.data.JsonStore({
					url: '../../sis_proveedores/control/CategoriaProveedor/listarCategoriaProveedor',
					id: 'id_categoria',
					root: 'datos',
					sortInfo: {
		...
		},
		{
			config: {
				...
				emptyText: 'Elija una opción...',
				store: new Ext.data.JsonStore({
					url: '../../sis_proveedores/control/ClasificacionProveedor/listarClasificacionProveedor',
					id: 'id_clasificacion',
					root: 'datos',
					sortInfo: {
					...
					totalProperty: 'total',
					fields: ['id_clasificacion', 'nombre_clasificacion', 'descripcion'],
					remoteSort: true,
	...
	tam_pag:50,	
	title:'Documentos',
	ActSave:'../../sis_proveedores/control/DocumentoCategoriaClasificacion/insertarDocumentoCategoriaClasificacion',
	ActDel:'../../sis_proveedores/control/DocumentoCategoriaClasificacion/eliminarDocumentoCategoriaClasificacion',
	ActList:'../../sis_proveedores/control/DocumentoCategoriaClasificacion/listarDocumentoCategoriaClasificacion',
